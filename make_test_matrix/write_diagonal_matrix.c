...
int main(int argc,char **args){
    char *petsc_full_filename = "diagonalMatrix1.petsc";
...
void writeDiagonalMatrixInPetscFormat(char *petsc_full_filename){
    ...
    for(i=0; i<N; i++){
        for(j=0; j<N; j++){
            ...
            *temp_PetscScalar_bswp_val = 2; // constant value on diagonal
